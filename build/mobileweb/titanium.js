...
var require = {
	app: {
		analytics: true,
		copyright: "2013 by fviAtt",
		deployType: "development",
		description: "not specified",
		guid: "5dabcb2f-8858-48d6-9e2d-f1394fd62ba7",
		id: "com.cyberagent.app.manga",
		name: "MangaView",
		names: {},
		publisher: "fviAtt",
		url: "http://",
...
*/
defineCloud(exports);
function defineCloud(m){var b;function u(b,a,d){if(void 0===a)throw"Argument "+b+" was not provided!";if(typeof a!=d)throw"Argument "+b+" was an unexpected type! Expected: "+d+", Received: "+typeof a;}function q(b,a){u("data",b,"object");u("callback",a,"function");w(this);this.url||(this.url=this.restNamespace+"/"+this.restMethod+".json");m.debug&&Ti.API.info('ACS Request: { url: "'+this.url+'", verb: "'+this.verb+'", data: '+JSON.stringify(b)+" })");g.send(this.url,this.verb,b,function(d){if(a){var c=
d.response||{};d.meta&&"ok"==d.meta.status?(c.success=!0,c.error=!1,c.meta=d.meta,m.debug&&Ti.API.info(JSON.stringify(c))):(c.success=!1,c.error=!0,c.code=d.meta?d.meta.code:d.statusCode,c.message=d.meta?d.meta.message:d.message||d.statusText,m.debug&&Ti.API.error(c.code+": "+c.message));a(c)}})}function i(){q.call(this,2==arguments.length?arguments[0]:{},2==arguments.length?arguments[1]:arguments[0])}function x(b){q.call(this,{},b)}function w(b){b.restNamespace||(b.restNamespace=b.property.toLowerCase());
b.restMethod||(b.restMethod=b.method.toLowerCase())}function B(b,a){u("callback",a,"function");var d={};d.params=b||{};d.params.cb=function(d){if(a){var b=d||{};d&&d.access_token?(b.success=!0,b.error=!1,m.debug&&Ti.API.info("ACS Token: "+d.access_token+" Expires: "+d.expires_in)):(b.success=!1,b.error=!0,b.message="Cancelled",m.debug&&Ti.API.error("ACS "+b.message));a(b)}};g.secureSend(this.method,d)}function y(){B.call(this,2==arguments.length?arguments[0]:{},2==arguments.length?arguments[1]:arguments[0])}
function v(b,a){b[a>>5]|=128<<24-a%32;b[(a+64>>9<<4)+15]=a;for(var d=Array(80),c=1732584193,h=-271733879,f=-1732584194,e=271733878,k=-1009589776,j=0;j<b.length;j+=16){for(var g=c,i=h,s=f,m=e,p=k,l=0;80>l;l++){d[l]=16>l?b[j+l]:(d[l-3]^d[l-8]^d[l-14]^d[l-16])<<1|(d[l-3]^d[l-8]^d[l-14]^d[l-16])>>>31;var o=c<<5|c>>>27,q;q=20>l?h&f|~h&e:40>l?h^f^e:60>l?h&f|h&e|f&e:h^f^e;o=r(r(o,q),r(r(k,d[l]),20>l?1518500249:40>l?1859775393:60>l?-1894007588:-899497514));k=e;e=f;f=h<<30|h>>>2;h=c;c=o}c=r(c,g);h=r(h,i);
f=r(f,s);e=r(e,m);k=r(k,p)}return[c,h,f,e,k]}function r(b,a){var d=(b&65535)+(a&65535);return(b>>16)+(a>>16)+(d>>16)<<16|d&65535}function z(b){for(var a=[],d=(1<<o)-1,c=0;c<b.length*o;c+=o)a[c>>5]|=(b.charCodeAt(c/o)&d)<<32-o-c%32;return a}function p(e,a,d,c,h){var f=!1;this.appKey=e;this.oauthKey=a;this.oauthSecret=d;this.apiBaseURL=c?c:b.sdk.url.baseURL;this.authBaseURL=h?h:b.sdk.url.authBaseURL;this.useThreeLegged=function(a){f=a;this.oauthKey||(this.oauthKey=this.appKey)};this.isThreeLegged=function(){return f};
return this}var t={PROPERTY_TYPE_ONLY_LATEST:0,PROPERTY_TYPE_SLASH_COMBINE:1,PROPERTY_TYPE_IGNORE:2};t.build=function a(d,c){var b=c.children||[],f;for(f in b)if(b.hasOwnProperty(f)){var e=b[f],g=e.propertyTypes||c.propertyTypes||{};g.children=t.PROPERTY_TYPE_IGNORE;for(var j in c)if(c.hasOwnProperty(j))switch(g[j]||t.PROPERTY_TYPE_ONLY_LATEST){case t.PROPERTY_TYPE_ONLY_LATEST:e[j]=void 0===e[j]?c[j]:e[j];break;case t.PROPERTY_TYPE_SLASH_COMBINE:var n=[];c[j]&&n.push(c[j]);e[j]&&n.push(e[j]);e[j]=
n.join("/")}e.method&&!e.children?d[e.method]=function(a){return function(){return a.executor.apply(a,arguments)}}(e):e.property&&a(d[e.property]={},e)}};t.build(m,{verb:"GET",executor:q,children:[{method:"hasStoredSession",executor:function(){Ti.API.warn("Cloud.hasStoredSession has been deprecated. Use Cloud.sessionId property");return g.hasStoredSession()}},{method:"retrieveStoredSession",executor:function(){Ti.API.warn("Cloud.retrieveStoredSession has been deprecated. Use Cloud.sessionId property");
return g.retrieveStoredSession()}},{property:"ACLs",children:[{method:"create",verb:"POST"},{method:"update",verb:"PUT"},{method:"show"},{method:"remove",restMethod:"delete",verb:"DELETE"},{method:"addUser",restMethod:"add",verb:"POST"},{method:"removeUser",restMethod:"remove",verb:"DELETE"},{method:"checkUser",restMethod:"check"}]},{property:"Chats",children:[{method:"create",verb:"POST"},{method:"query"},{method:"getChatGroups",restMethod:"get_chat_groups",executor:i}]},{property:"Checkins",children:[{method:"create",
verb:"POST"},{method:"query",executor:i},{method:"show"},{method:"remove",restMethod:"delete",verb:"DELETE"}]},{property:"Clients",children:[{method:"geolocate",executor:i}]},{property:"Objects",executor:function(a,d){var c;a&&"object"==typeof a&&(u("data.classname",a.classname,"string"),w(this),this.url=this.restNamespace+"/"+a.classname+"/"+this.restMethod+".json",c=a.classname,delete a.classname);q.call(this,a,d);a.classname=c},children:[{method:"create",verb:"POST"},{method:"show"},{method:"update",
...
executor:i},{method:"update",verb:"PUT"},{method:"remove",restMethod:"delete",verb:"DELETE"}]},{property:"Files",children:[{method:"create",verb:"POST"},{method:"query",executor:i},{method:"show"},{method:"update",verb:"PUT"},{method:"remove",restMethod:"delete",verb:"DELETE"}]},{property:"Friends",children:[{method:"add",verb:"POST"},{method:"requests",executor:i},{method:"approve",verb:"PUT"},{method:"remove",verb:"DELETE"},{method:"search"}]},{property:"KeyValues",children:[{method:"set",verb:"PUT"},
{method:"get"},{method:"append",verb:"PUT"},{method:"increment",restMethod:"incrby",verb:"PUT"},{method:"remove",restMethod:"delete",verb:"DELETE"}]},{property:"Messages",children:[{method:"create",verb:"POST"},{method:"reply",verb:"POST"},{method:"show"},{method:"showInbox",restMethod:"show/inbox",executor:i},{method:"showSent",restMethod:"show/sent",executor:i},{method:"showThreads",restMethod:"show/threads",executor:i},{method:"showThread",restMethod:"show/thread"},{method:"remove",restMethod:"delete",
verb:"DELETE"},{method:"removeThread",restMethod:"delete/thread",verb:"DELETE"}]},{property:"Photos",children:[{method:"create",verb:"POST"},{method:"show"},{method:"search"},{method:"query",executor:i},{method:"update",verb:"PUT"},{method:"remove",restMethod:"delete",verb:"DELETE"}]},{property:"PhotoCollections",restNamespace:"collections",children:[{method:"create",verb:"POST"},{method:"show"},{method:"update",verb:"PUT"},{method:"search"},{method:"showSubcollections",restMethod:"show/subcollections"},
{method:"showPhotos",restMethod:"show/photos"},{method:"remove",restMethod:"delete",verb:"DELETE"}]},{property:"Places",children:[{method:"create",verb:"POST"},{method:"search",executor:i},{method:"show"},{method:"update",verb:"PUT"},{method:"remove",restMethod:"delete",verb:"DELETE"},{method:"query",executor:i}]},{property:"Posts",children:[{method:"create",verb:"POST"},{method:"show"},{method:"query",executor:i},{method:"update",verb:"PUT"},{method:"remove",restMethod:"delete",verb:"DELETE"}]},
{property:"PushNotifications",restNamespace:"push_notification",verb:"POST",children:[{method:"subscribe"},{method:"unsubscribe",verb:"DELETE"},{method:"notify"},{method:"subscribeToken",restMethod:"subscribe_token",verb:"POST"},{method:"unsubscribeToken",restMethod:"unsubscribe_token",verb:"DELETE"},{method:"notifyTokens",restMethod:"notify_tokens",verb:"POST"}]},{property:"Reviews",children:[{method:"create",verb:"POST"},{method:"show"},{method:"query"},{method:"update",verb:"PUT"},{method:"remove",
restMethod:"delete",verb:"DELETE"}]},{property:"SocialIntegrations",restNamespace:"users",children:[{method:"externalAccountLogin",restMethod:"external_account_login",verb:"POST"},{method:"externalAccountLink",restMethod:"external_account_link",verb:"POST"},{method:"externalAccountUnlink",restMethod:"external_account_unlink",verb:"DELETE"},{method:"searchFacebookFriends",restNamespace:"social",restMethod:"facebook/search_friends",executor:x}]},{property:"Statuses",children:[{method:"create",verb:"POST"},
{method:"search"},{method:"query",executor:i}]},{property:"Users",children:[{method:"create",verb:"POST"},{method:"login",verb:"POST"},{method:"show"},{method:"showMe",restMethod:"show/me",executor:x},{method:"search",executor:i},{method:"query",executor:i},{method:"update",verb:"PUT"},{method:"logout",executor:function(a){q.call(this,{},function(d){g.reset();a(d)})}},{method:"remove",restMethod:"delete",verb:"DELETE",executor:function(){var a=arguments;q.call(this,2==a.length?a[0]:{},function(d){g.reset();
(2==a.length?a[1]:a[0])(d)})}},{method:"requestResetPassword",restMethod:"request_reset_password"},{method:"secureCreate",executor:y},{method:"secureLogin",executor:y},{method:"secureStatus",executor:function(){return g.checkStatus()}}]}]});var e;null==e&&(e={});e.setProperties=function(a,d){if(null!=a&&null!=d)for(var c in d)a[c]=d[c];return a};e.setProperties(e,{percentEncode:function(a){if(null==a)return"";if(a instanceof Array){for(var d="";0<a.length;++a)""!=d&&(d+="&"),d+=e.percentEncode(a[0]);
return d}a=encodeURIComponent(a);a=a.replace(/\!/g,"%21");a=a.replace(/\*/g,"%2A");a=a.replace(/\'/g,"%27");a=a.replace(/\(/g,"%28");return a=a.replace(/\)/g,"%29")},decodePercent:function(a){null!=a&&(a=a.replace(/\+/g," "));return decodeURIComponent(a)},getParameterList:function(a){if(null==a)return[];if("object"!=typeof a)return e.decodeForm(a+"");if(a instanceof Array)return a;var d=[],c;for(c in a)d.push([c,a[c]]);return d},getParameterMap:function(a){if(null==a)return{};if("object"!=typeof a)return e.getParameterMap(e.decodeForm(a+
...
"development";j.sid=Ti.App.sessionId;k.ti_analytics=JSON.stringify(j)}c=b.js.sdk.utils.cleanInvalidData(c);if(a=b.js.sdk.utils.getFileObject(c)){try{var n;n=a.toString().match(/TiFilesystemFile/)?a.read():a;if(!n){h(b.constants.fileLoadError);return}c[b.constants.file]?(delete c[b.constants.file],c[b.constants.file]=n):c[b.constants.photo]&&(delete c[b.constants.photo],c[b.constants.photo]=n)}catch(i){h(b.constants.fileLoadError);return}n={};if(f==b.constants.oauth||f==b.constants.three_legged_oauth)f=
...
e.completeRequest(f,{consumerSecret:this.oauthSecret});n[b.constants.oauth_header]=e.getAuthorizationHeader("",f.parameters)}b.js.sdk.utils.sendAppceleratorRequest(g,d,c,n,h,this)}};p.prototype.sendAuthRequest=function(a){if(b.js.sdk.utils.getAuthType(this)!==b.constants.three_legged_oauth)alert("wrong authorization type!");else{var a=a||{},d=this.authBaseURL,d=d+"/oauth/authorize"+(b.constants.oauthKeyParam+this.oauthKey),d=d+(b.constants.clientIdParam+this.oauthKey),d=d+(b.constants.responseTypeParam+
...
e.nonce(15)]))};b.js.sdk.utils.sendAppceleratorRequest=function(a,d,c,h,f,g){var k=Ti.Network.createHTTPClient({timeout:6E4,onsendstream:function(b){m.onsendstream&&m.onsendstream({url:a,progress:b.progress})},ondatastream:function(b){m.ondatastream&&m.ondatastream({url:a,progress:b.progress})},onerror:function(a){var b={};if(this.responseText){var c=this.responseText;try{(c=c.trim())&&0<c.length&&(b=JSON.parse(c))}catch(d){b=d}}b.message||(b.message=a.error);b.error=!0;b.statusText=this.statusText;
b.status=this.status;b.meta&&(b.metaString=JSON.stringify(b.meta));f(b)},onload:function(){var a=JSON.parse(this.responseText);if(a&&a.meta&&(a.metaString=JSON.stringify(a.meta),a.meta.session_id)){var c=a.meta.session_id;b.js.sdk.utils.setCookie(b.constants.sessionId,c);g.session_id=c}f(a)}}),j=a;if(d.toUpperCase()==b.constants.get_method||d.toUpperCase()==b.constants.delete_method){var n="",i;for(i in c)c.hasOwnProperty(i)&&(n+="&"+i+"="+e.percentEncode(c[i]));0<n.length&&(j=0<a.indexOf("?")?j+
n:j+("?"+n.substring(1)),c={})}m.debug&&(Ti.API.info(d+": "+j),Ti.API.info("header: "+JSON.stringify(h)),Ti.API.info("data: "+JSON.stringify(c)));k.open(d,j);"mobileweb"!=Ti.Platform.osname&&k.setRequestHeader("Accept-Encoding","gzip,deflate");if(h)for(i in h)h.hasOwnProperty(i)&&k.setRequestHeader(i,h[i]);k.send(c)};b.js.sdk.utils.decodeQS=function(a){var b=decodeURIComponent,c={},a=a.split("&"),e,f;for(e=0;e<a.length;e++)(f=a[e].split("=",2))&&f[0]&&(c[b(f[0])]=b(f[1]));return c};b.js.sdk.utils.guid=
function(){return"f"+(1073741824*Math.random()).toString(16).replace(".","")};b.js.sdk.utils.copy=function(a,b,c,e){for(var f in b)if(c||"undefined"===typeof a[f])a[f]=e?e(b[f]):b[f];return a};var g={session:null,fetchSetting:function(a,b){var c,e="production"==Ti.App.deployType.toLowerCase()?"production":"development";return(c=Ti.App.Properties.getString(a+"-"+e))&&"undefined"!=c||(c=Ti.App.Properties.getString(a))&&"undefined"!=c?c:b},fetchSession:function(){var a=g.fetchSetting("acs-api-key",null),
d=g.fetchSetting("acs-base-url",b.sdk.url.baseURL),c=g.fetchSetting("acs-authbase-url",b.sdk.url.authBaseURL),e=g.fetchSetting("acs-oauth-key",null),f=g.fetchSetting("acs-oauth-secret",null);return new p(a,e,f,d,c)}};g.getSession=function(){null==g.session&&(g.session=g.fetchSession());return g.session};g.send=function(a,b,c,e){g.getSession().sendRequest(a,b,c,e)};g.hasStoredSession=function(){return!!b.js.sdk.utils.getCookie(b.constants.sessionId)};g.retrieveStoredSession=function(){return b.js.sdk.utils.getCookie(b.constants.sessionId)};
g.reset=function(){b.js.sdk.utils.deleteCookie(b.constants.sessionId);g.session&&(g.session.clearSession(),g.session=null)};g.secureSend=function(a,b){var c=g.getSession();c.useThreeLegged(!0);"secureCreate"===a?c.signUpRequest(b):"secureLogin"===a&&c.sendAuthRequest(b)};g.checkStatus=function(){return g.getSession().checkStatus()};b.js.sdk.UIManager={redirect_uri:"acsconnect://success",displayModal:function(a){function d(a){var i=/^acsconnect:\/\/([^#]*)#(.*)/.exec(decodeURIComponent(a.url));if(i&&
3==i.length){var k=null;if("success"==i[1])k=b.js.sdk.utils.decodeQS(i[2]);else if("cancel"!=i[1])return;e.removeEventListener("beforeload",d);e.removeEventListener("load",d);g=k;c&&c.close()}f&&"load"==a.type&&(c.remove(f),f=null)}m.debug&&Ti.API.info("ThreeLegged Request url: "+a.url);var c=Ti.UI.createWindow({modal:!0,title:a.params.title||"Appcelerator Cloud Service"}),e=Ti.UI.createWebView({url:a.url,scalesPageToFit:!1,showScrollbars:!0}),f=Ti.UI.createLabel({text:"Loading, please wait...",color:"black",
width:Ti.UI.SIZE||"auto",height:Ti.UI.SIZE||"auto",zIndex:100}),g;e.addEventListener("beforeload",d);e.addEventListener("load",d);c.addEventListener("close",function(){a&&(a.cb&&a.cb(g),e=c=f=a=g=null)});if("android"!=Ti.Platform.osname){var i=Ti.UI.createButton({title:"close",width:"50%",height:"20%"});i.addEventListener("click",function(){c.close()});c.rightNavButton=i}c.add(e);c.add(f);c.open()},processParams:function(a,d){return{cb:d,url:a.url+b.constants.redirectUriParam+b.js.sdk.UIManager.redirect_uri,
params:a}}};b.js.sdk.ui=function(a,d){if("mobileweb"===Ti.Platform.osname)alert("Three Legged OAuth is not currently supported on MobileWeb");else if(a.action){var c=b.js.sdk.UIManager.processParams(a,d);c&&b.js.sdk.UIManager.displayModal(c)}else alert('"action" is a required parameter for com.cocoafish.js.sdk.ui().')};return m};
});
}});
require("Ti/App/Properties", function(p) {
	p.setString("acs-oauth-secret-development","ODPuqZ2uTyHDwroSHcdDDH4xBuBxXXCg");
	p.setString("acs-oauth-key-development","hX3jdyXvBlG7SAWBpD15VrEr6kkJq80X");
	p.setString("acs-api-key-development","RsQZIBQpGyGIbBAx9d7R6UgeVVTiKLAg");
	p.setString("acs-oauth-secret-production","xZlCmQZqTFDjRK4RIWPRSfCeLDX2p86T");
	p.setString("acs-oauth-key-production","AIImEn5iNpM0h7hPtv6mcYTNM2ysthwq");
	p.setString("acs-api-key-production","P0RzIrEpYaFbeIt9kPcsce39W2bD7k8G");
