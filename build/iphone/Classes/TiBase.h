...
// in simulator we redefine to format for MangaView Developer console
...
{\
	NSString * exceptionName = [@"org.mangaview." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mangaview";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMangaViewNativeItemNone = -1, 
	UIMangaViewNativeItemSpinner = -2,
	UIMangaViewNativeItemProgressBar = -3,
	
	UIMangaViewNativeItemSlider = -4,
	UIMangaViewNativeItemSwitch = -5,
	UIMangaViewNativeItemMultiButton = -6,
	UIMangaViewNativeItemSegmented = -7,
	
	UIMangaViewNativeItemTextView = -8,
	UIMangaViewNativeItemTextField = -9,
	UIMangaViewNativeItemSearchBar = -10,
	
	UIMangaViewNativeItemPicker = -11,
	UIMangaViewNativeItemDatePicker = -12,
	
	UIMangaViewNativeItemInfoLight = -13,
	UIMangaViewNativeItemInfoDark = -14,
	
	UIMangaViewNativeItemDisclosure = -15,
	
	UIMangaViewNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MangaView instances of
