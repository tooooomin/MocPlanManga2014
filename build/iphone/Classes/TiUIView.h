...
/**
 Base class for all MangaView views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MangaView view hierarchy (such as wrapped iOS UIViews) was touched.
