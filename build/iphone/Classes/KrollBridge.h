...
@interface MangaViewObject : KrollCoverageObject {
#else
@interface MangaViewObject : KrollObject {
#endif
@private
...
extern NSString * MangaView$ModuleRequireFormat;
