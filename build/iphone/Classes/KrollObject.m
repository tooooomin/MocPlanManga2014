...
//@interface MangaViewObject : NSObject
//@end

@interface MangaViewObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MangaViewObject class]])
		{
			for (NSString *key in [[(MangaViewObject*)o modules] allKeys])
			{
